...
def build_endpoint_deployment_payload(row: Any) -> dict[str, Any]:
    return {
        ...
        "active_module_import_id": _value(row, "active_module_import_id"),
        "target_build_id": _value(row, "target_build_id"),
        "target_revision_id": _value(row, "target_revision_id"),
        "target_module_import_id": _value(row, "target_module_import_id"),
        "previous_build_id": _value(row, "previous_build_id"),
        "previous_revision_id": _value(row, "previous_revision_id"),
        "previous_module_import_id": _value(row, "previous_module_import_id"),
        "failed_build_id": _value(row, "failed_build_id"),
        "failed_revision_id": _value(row, "failed_revision_id"),
        "failed_module_import_id": _value(row, "failed_module_import_id"),
        "phase": _value(row, "phase"),
        "desired_replica_count": int(_value(row, "desired_replica_count") or 0),
        "legacy_fallback": bool(_value(row, "legacy_fallback", True)),
...
def build_managed_container_payload(row: Any) -> dict[str, Any]:
    return {
        ...
        "worker_id": _value(row, "worker_id"),
