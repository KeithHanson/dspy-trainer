...
def _generated_entrypoint(*, build_id: str, revision_id: str) -> str:
    return "\n".join(
        [
            ...
            ': "${DSPY_TRAINER_ENDPOINT_DEPLOYMENT_ID:?DSPY_TRAINER_ENDPOINT_DEPLOYMENT_ID is required}"',
            ': "${DSPY_TRAINER_ENDPOINT_ROLLOUT_GENERATION:?DSPY_TRAINER_ENDPOINT_ROLLOUT_GENERATION is required}"',
            ': "${DSPY_TRAINER_ENDPOINT_SLOT:?DSPY_TRAINER_ENDPOINT_SLOT is required}"',
            "exec env -i \\",
            ...
            '  DSPY_TRAINER_ENDPOINT_DEPLOYMENT_ID="$DSPY_TRAINER_ENDPOINT_DEPLOYMENT_ID" \\',
            '  DSPY_TRAINER_ENDPOINT_ROLLOUT_GENERATION="$DSPY_TRAINER_ENDPOINT_ROLLOUT_GENERATION" \\',
            '  DSPY_TRAINER_ENDPOINT_SLOT="$DSPY_TRAINER_ENDPOINT_SLOT" \\',
